# practice-cards-circle · A

Statement: <https://codeforces.com/problemset/problem/CONTEST_ID/A  ← fill CONTEST_ID in browser>
...
```bash
/Users/sanka/IdeaProjects/codeforces/bin/cf run practice-cards-circle A
# or cd here and run:
...
```bash
/Users/sanka/IdeaProjects/codeforces/bin/cf use practice-cards-circle A
```
